<div class="w-full m-auto overflow-hidden ">
    <div class=" h-[50vh] w-[300%] flex ml-[-100%] lg:h-[90vh]" id="slider">            
        ...
        <div class="cursor-pointer flex items-center justify-center text-4xl font-bold z-40 absolute  leading-[23px] left-14 top-1/2 w-11 h-11 bg-gray-100 shadow-md rounded-full text-gray-900 text-opacity-60  hover:bg-gray-200" id="btn-left">
        ...
        <div class="flex items-center justify-center w-11 h-11 shadow-md right-14 hover:bg-gray-200 cursor-pointer z-40  absolute top-1/2 text-4xl  text-gray-900 text-opacity-70 leading-[23px]  bg-gray-100 rounded-full" id="btn-right">
            <svg class=" w-8 h-8 font-bold transition duration-500 ease-in-out transform motion-reduce:transform-none text-gray-500 hover:text-gray-600 hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
