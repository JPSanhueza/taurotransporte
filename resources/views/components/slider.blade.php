<div class="w-full m-auto overflow-hidden ">
    <div class=" h-[50vh] w-[400%] flex ml-[-100%] lg:h-[90vh]" id="slider">
        <div class="relative w-full slider__section">
            <picture>
                <source media="(min-width: 1024px)" srcset="{{asset('img/slider/slider1.jpg')}}"/>
                <img src="{{asset('img/slider/slider1M.jpg')}}" alt="Slider1" class="block object-cover w-full h-full"/>                
            </picture>
        </div>
        <div class="w-full slider__section">
            <picture>
                <source media="(min-width: 1024px)" srcset="{{asset('img/slider/slider2.jpg')}}" class="object-cover"/>
                <img src="{{asset('img/slider/slider2M.jpg')}}" alt="Slider1" class="block object-cover w-full h-full"/>
            </picture>
        </div>
        <div class="w-full slider__section">
            <picture>
                <source media="(min-width: 1024px)" srcset="{{asset('img/slider/slider3.jpg')}}"/>
                <img src="{{asset('img/slider/slider3M.jpg')}}" alt="Slider1" class="block object-cover w-full h-full"/>
            </picture>
        </div>
        <div class="w-full slider__section">
            <picture>
                <source media="(min-width: 1024px)" srcset="{{asset('img/slider/slider4.jpg')}}"/>
                <img src="{{asset('img/slider/slider4M.jpg')}}" alt="Slider1" class="block object-cover w-full h-full"/>
            </picture>
        </div>    
